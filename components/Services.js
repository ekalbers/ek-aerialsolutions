      ...
      <div className="pt-4 bg-white">
        <div className="xl:flex max-h-[85vh] w-full items-center md:w-fit">
          ...
          <div className="max-h-[85vh]">
            <img src="Screenshot 2023-07-24 at 4.21.20 PM.png" className="xl:h-fit md:w-fit" alt="EK Drones Logo"/>
          </div>
        </div>
        <div className="xl:flex max-h-[85vh] w-full items-center md:w-fit">
          <div className="max-h-[85vh]">
            <img src="/Screenshot 2023-07-24 at 4.04.56 PM.png" className="xl:h-fit md:w-fit" alt="EK Drones Logo"/>
          </div>
        ...
        <div className="xl:flex max-h-[85vh] w-full items-center md:w-fit">
          ...
          <div className="max-h-[85vh]">
            <img src="/Screenshot 2023-07-24 at 4.08.15 PM.png" className="xl:h-fit md:w-fit" alt="EK Drones Logo"/>
          </div>
        </div>
      </div>
    </>
